...
export default function FamilyTreePage({ onPersonClick, mobileMode = false }) {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-200">
      ...
      {/* Mobile Simplified Zoom Controls - Bottom Right, z-20 to stay below mobile top bar */}
      {mobileMode && (
        <div className="fixed bottom-20 right-4 z-20 flex flex-col gap-2">
          {/* Zoom Out */}
          <button className="p-3 bg-white border border-gray-300 rounded-full shadow-lg hover:bg-gray-50 active:bg-gray-100">
