...
export default function FamilyTreePage({ onPersonClick }) {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-200">
      ...
      <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
        {/* 1. TreePedigree Icon + LANDSCAPE */}
        <button className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 shadow-sm">
        ...
        {/* 2. Settings Button */}
        <button className="p-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 shadow-sm">
