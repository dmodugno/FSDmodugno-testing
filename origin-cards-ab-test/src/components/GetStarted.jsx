      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-sm text-gray-600 mb-3 flex-grow">
            Ready to start preserving your family history? A tree is a great way to start.
          </p>
        ...
        <div className="flex flex-col">
          ...
          <p className="text-sm text-gray-600 mb-3 flex-grow">
            Learn what is known about your family name.
          </p>
          <a href="#" className="text-sm text-teal-700 font-semibold hover:underline">
            Learn more ›
          </a>
        ...
        {/* Make discoveries - Sign in card */}
        <div className="flex flex-col bg-[#c4d82e] rounded-lg p-6 text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Make discoveries</h3>
          <p className="text-sm text-gray-800 mb-6">
            FamilySearch helps you discover your family story.
          </p>
          <div className="mt-auto">
            <p className="text-sm font-semibold text-gray-900 mb-4">Sign in with</p>
